...
final Context context = parent.getContext();
        ...
        descTextView1.setText(listViewItem.getDesc1());
        descTextView2.setText(listViewItem.getDesc2());
        descTextView3.setText(listViewItem.getDesc3());
...
public Object getItem(int position) {
    ...
    public void addItem(String title, String desc1,String desc2, String desc3) {
        List_item item = new List_item();


        item.setTitle(title);
        item.setDesc(desc1,desc2,desc3);
